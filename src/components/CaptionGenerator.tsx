      ...
      <div className="bg-white p-6 rounded-sm border border-slate-200 shadow-sm">
        ...
        <form onSubmit={handleGenerate} className="space-y-4 text-xs font-semibold text-slate-600">
          ...
          >
            ...
            {isGenerating ? 'Generating with AI...' : 'Generate Caption with AI'}
          </button>
        </form>
      </div>
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center text-slate-400 my-auto">
            {isGenerating ? (
              <div className="space-y-3">
                ...
                <p className="text-xs font-semibold text-slate-500">Generating your caption with AI...</p>
              </div>
            ) : (
              <div className="space-y-2 max-w-sm">
                <AlertCircle className="w-10 h-10 text-slate-300 mx-auto" />
                <h4 className="text-slate-700 font-bold text-sm font-display">Waiting for Caption Prompt</h4>
                <p className="text-xs text-slate-400">Describe your product offer, promotion, or hotel discount. AI will write tailored posts for you instantly.</p>
              </div>
            )}
          </div>
        )}
