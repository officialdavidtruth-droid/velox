      ...
      <div className="rounded-2xl p-4 flex items-start gap-3" style={{ background: 'var(--info-bg)', border: '1px solid var(--info)' }}>
        ...
        <div>
          ...
          <p className="text-xs leading-relaxed" style={{ color: 'var(--text-soft)' }}>
            Enter your ad spend, clicks, impressions, and conversions from your Meta Ads Manager, Google Ads, or TikTok Ads dashboard. Velox Space calculates ROAS, CTR, CPC, and CPA from your real numbers. Data is saved to your browser.
          </p>
        </div>
      </div>
