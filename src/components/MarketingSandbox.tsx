                  ...
                  {platforms.tiktok && (
                    <div className="p-4 space-y-3 bg-slate-950 text-white relative">
                      ...
                      <div className="space-y-1 text-left font-sans text-[10px]">
                        ...
                        <span className="text-[8.5px] text-cyan-400 font-mono">♬ Original Sound - Velox Space Audio</span>
                      </div>
                    ...
                    <div className="p-4 space-y-3 bg-white dark:bg-slate-900">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-1.5">
                          ...
                          />
                          <div>
                            <span className="text-[9.5px] font-extrabold text-slate-900 dark:text-white block leading-tight">Velox Space Agency</span>
